...
{
    public class ChoShellScriptFilePlugInBuilderProperty : ChoPlugInBuilderProperty, IChoScriptExtensionObject
    {
        public class BATFileNameEditor : FileNameEditor
        {
            protected override void InitializeDialog(System.Windows.Forms.OpenFileDialog openFileDialog)
            {
                openFileDialog.Filter = "Batch files (*.BAT)|*.BAT|Command files (*.CMD)|*.CMD";
        ...
        [Description("DOS batch script file path")]
        [DisplayName("ScriptFile")]
        [EditorAttribute(typeof(BATFileNameEditor), typeof(UITypeEditor))]
