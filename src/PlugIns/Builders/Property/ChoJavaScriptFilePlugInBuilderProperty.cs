...
{
    public class ChoJavaScriptFilePlugInBuilderProperty : ChoPlugInBuilderProperty, IChoScriptExtensionObject
    {
        public class JSFileNameEditor : FileNameEditor
        {
            protected override void InitializeDialog(System.Windows.Forms.OpenFileDialog openFileDialog)
            {
                openFileDialog.Filter = "JS files (*.JS)|*.JS";
        ...
        [Description("Java script file path")]
        [DisplayName("ScriptFile")]
        [EditorAttribute(typeof(JSFileNameEditor), typeof(UITypeEditor))]
