...
{
    public class ChoVBScriptPlugInBuilderProperty : ChoPlugInBuilderProperty, IChoScriptExtensionObject
    {
        private string _script;
        
        [Category("Miscellaneous")]
        [Description("VB Script code snippet")]
        [DisplayName("Script")]
