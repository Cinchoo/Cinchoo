...
{
    public class ChoShellScriptFilePlugIn : ChoPlugIn
    {
        ...
        protected override object Execute(object value, out bool isHandled)
        {
            ...
            using (ChoProcess p = new ChoProcess(scriptFilePath, arguments))
            {
        ...
        public override void InitializeBuilder(ChoPlugInBuilder builder)
        {
            ...
            ChoShellScriptFilePlugInBuilder b = builder as ChoShellScriptFilePlugInBuilder;
