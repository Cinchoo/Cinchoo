namespace Cinchoo.Core.Win32.Dialogs
{
    #region NameSpaces
    ...
    public class ChoFolderBrowserDialog : System.Windows.Forms.CommonDialog
    {
        ...
        // ctor
        public ChoFolderBrowserDialog()
        {
            this.Reset();
        }

        // Factory Methods
        public static ChoFolderBrowserDialog PrinterBrowser()
        {
            ChoFolderBrowserDialog x = new ChoFolderBrowserDialog();
            // avoid MBRO comppiler warning when passing _rootFolderLocation as a ref:
            x.BecomePrinterBrowser();
            return x;
        }

        public static ChoFolderBrowserDialog ComputerBrowser()
        {
            ChoFolderBrowserDialog x = new ChoFolderBrowserDialog();
            // avoid MBRO comppiler warning when passing _rootFolderLocation as a ref:
