...
namespace Cinchoo.Core
{
    ...
    public class ChoAESEncryptConverterAttribute : ChoTypeConverterAttribute
    {
        public ChoAESEncryptConverterAttribute()
            : base(typeof(ChoAESEncryptConverter))
        {
        }
    }

    public class ChoAESEncryptConverter : IValueConverter
    {
