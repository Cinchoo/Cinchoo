    ...
    public class ChoTypeConverterAttribute : Attribute
    {
        ...
        public ChoTypeConverterAttribute(Type converterType)
        {
            if (converterType != null)
            {
                ...
                //    || typeof(IChoValueConverter).IsAssignableFrom(converterType)
                //    || typeof(IChoMultiValueConverter).IsAssignableFrom(converterType)
                ...
                //else
                    ...
                    //ChoTrace.Error("Invalid `{0}` Converter Type passed".FormatString(converterType.FullName));
            }
        }
