namespace Cinchoo.Core
{
	...
	[Serializable]
	public abstract class ChoInterceptableObject : DynamicObject /*ContextBoundObject */, IDisposable
	{
		#region Constructors
		...
		[ChoHiddenMember]
		public static ChoInterceptableObject Silentable(ChoInterceptableObject interceptableObject)
        {
