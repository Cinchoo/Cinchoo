...
using System.IO;
    ...
    /// </summary>
    public class ChoNoCloseStreamWriter : StreamWriter
    {
        /// <summary>
        ...
        public ChoNoCloseStreamWriter(Stream stream, Encoding encoding)
        ...
        /// <param name="stream">The underlying stream to write to.</param>
        /// <param name="encoding">The encoding for the stream.</param>
        public ChoNoCloseStreamWriter(Stream stream)
            : base(stream)
        {
        }
