namespace Cinchoo.Core.Collections.Generic
{
    ...
    {
        [Serializable]
        private class ChoSynchronizedList<T1> : ChoList<T1>, ICloneable
        {
            ...
            internal ChoSynchronizedList(ChoList<T1> list)
            {
                _innerList = list;
            }
            ...
            {
                return new ChoSynchronizedEnumerator<T1>(_innerList, this.SyncRoot);
            }
            ...
            {
                return new ChoSynchronizedList<T1>(base.Clone() as ChoList<T1>);
            }
