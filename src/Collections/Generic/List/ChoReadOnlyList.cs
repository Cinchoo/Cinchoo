namespace Cinchoo.Core.Collections.Generic
{
    ...
    {
        [Serializable]
        private class ChoReadOnlyList<T1> : ChoList<T1>, ICloneable
        {
            ...
            {
                return new ChoReadOnlyList<T1>(base.Clone() as ChoList<T1>);
            }
            ...
            {
                if (!_silent)
                    throw new ApplicationException("Collection is readonly.");
            }
