namespace Cinchoo.Core.Collections.Generic
{
    ...
    public struct ChoEnumeratorConst
    {
        #region Constants
    ...
    public abstract class ChoBaseEnumerator<T> : ChoSyncDisposableObject, IEnumerator<T>, IEnumerable
    {
        #region Shared Data Members (Private)

        protected static readonly Predicate<T> DefaultMatch = item => true;
