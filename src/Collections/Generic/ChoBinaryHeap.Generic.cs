namespace eSquare.Core.Collections.Generic
{
    ...
    public class ChoBinaryHeap<T> : ICollection<T>, ICloneable
    {
        ...
        public ChoBinaryHeap(int capacity) { _list = new ChoList<T>(capacity); }

        /// <summary>Initialize the heap.</summary>
        public ChoBinaryHeap() { _list = new ChoList<T>(); }
        ...
        public virtual ChoBinaryHeap<T> Clone() { return new ChoBinaryHeap<T>(this); }
        ...
        {
            foreach (ChoBinaryHeapEntry<T> entry in _list)
            {
        ...
        public class ChoBinaryHeapEnumerator<T> : IEnumerator<T>
        {
            #region Member Variables
            ...
            internal ChoBinaryHeapEnumerator(IEnumerator<T> enumerator)
            {
            ...
            public object Current
            {
                get
                {
                    ...
                    ChoBinaryHeapEntry<T> entry = _enumerator.Current as ChoBinaryHeapEntry<T>;
        ...
        {
            return new ChoBinaryHeapEnumerator<T>(_list.GetEnumerator());
        }
        ...
        public static ChoBinaryHeap Synchronize(ChoBinaryHeap heap)
        {
            ...
            if (heap is SyncChoBinaryHeap) return heap;
            return new SyncChoBinaryHeap(heap);
        }

        #endregion

        #region ChoBinaryHeapEntry Class

        /// <summary>Represents an entry in a binary heap.</summary>
        private class ChoBinaryHeapEntry<TKey> : IComparable<TKey>, ICloneable
        {
            #region Member Variables

            /// <summary>The key for this entry.</summary>
            private IComparable<TKey> _key;
            ...
            /// <param name="key">The key for this entry.</param>
            /// <param name="value">The value for this entry.</param>
            public ChoBinaryHeapEntry(IComparable<TKey> key, object value)
            {
                _key = key;
                _value = value;
            }
            ...
            /// </returns>
            public int CompareTo(ChoBinaryHeapEntry<TKey> entry)
            {
            ...
            /// Greater than 0 if this instance is greater than the argument.
            /// </returns>
            int IComparable<TKey>.CompareTo(TKey other)
            {
                // Make sure we have valid arguments, then compare.
                if (!(other is ChoBinaryHeapEntry<TKey>)) throw new ArgumentException("Object is not a ChoBinaryHeapEntry<TKey>", "obj");
                return CompareTo((ChoBinaryHeapEntry<TKey>)obj);
            }
            ...
            public ChoBinaryHeapEntry<TKey> Clone()
            {
                return new ChoBinaryHeapEntry<TKeyKey, object>(_key, _value);
            }
        ...
        #endregion ChoBinaryHeapEntry Class

        /*
        /// <summary>A synchronized ChoBinaryHeap.</summary>
        public class SyncChoBinaryHeap : ChoBinaryHeap
        {
            #region Member Variables
            ...
            internal SyncChoBinaryHeap(ChoBinaryHeap heap) { _heap = heap; }
            #endregion
