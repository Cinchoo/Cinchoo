namespace Cinchoo.Core.Collections.Generic
{
	...
	{
		#region ChoReadOnlyDictionary Class

		private class ChoReadOnlyDictionary<TKey1, TValue1> : ChoDictionary<TKey1, TValue1>, IDictionary<TKey1, TValue1>, ICloneable
		{
			...
			public override TValue1 this[TKey1 key]
			{
				...
				set
				{
					throw new NotSupportedException("NotSupported_ReadOnlySizeDictionary");
				}
			}
			...
			{
				return new ChoReadOnlyDictionary<TKey1, TValue1>(_dictionary.Clone() as ChoDictionary<TKey1, TValue1>);
			}

			#endregion
		}

		#endregion ChoReadOnlyDictionary Class
	}
}
