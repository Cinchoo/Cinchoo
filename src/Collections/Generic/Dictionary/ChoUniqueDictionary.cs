namespace Cinchoo.Core.Collections.Generic
{
	...
	{
		#region ChoUniqueDictionary Class

		private class ChoUniqueDictionary<TKey1, TValue1> : ChoDictionary<TKey1, TValue1>, IDictionary<TKey1, TValue1>, ICloneable
		{
			...
			{
				return new ChoUniqueDictionary<TKey1, TValue1>(_dictionary.Clone() as ChoDictionary<TKey1, TValue1>);
			}

			#endregion
		}

		#endregion ChoUniqueDictionary Class
	}
}
