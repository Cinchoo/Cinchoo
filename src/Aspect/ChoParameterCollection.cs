namespace eSquare.Core.Aspect
{
    ...
    /// </summary>
    public class ChoParameterCollection : IChoParameterCollection
    {
        /// <summary>
        ...
        private List<ArgumentInfo> argumentInfo;
        private object[] arguments;

        /// <summary>
        /// Construct a new <see cref="ChoParameterCollection"/> that wraps the
        ...
        public ChoParameterCollection(object[] arguments, ParameterInfo[] argumentInfo, Predicate<ParameterInfo> isArgumentPartOfCollection)
        {
